...
const translations = {
    ...
    es: {
        ...
        'sitemap-subtitle': 'ESTRUCTURA COMPLETA DEL SITIO WEB',
        'main-page-section': 'PÁGINA PRINCIPAL',
        'main-page-sections': 'SECCIONES DE LA PÁGINA PRINCIPAL',
        'additional-pages': 'PÁGINAS ADICIONALES',
        'features-section': 'FUNCIONALIDADES',
        'project-info': 'INFORMACIÓN DEL PROYECTO',
        'home-page': 'Página de Inicio',
        'home-desc': 'Página principal con información general de la serie',
        'intro-section': 'Introducción',
        'intro-desc': 'Pantalla de bienvenida con video promocional',
        'synopsis-section': 'Sinopsis',
        'synopsis-desc': 'Resumen de la serie y trama principal',
        'characters-section': 'Personajes',
        'characters-desc': 'Galería de personajes principales con información detallada',
        'eva-units-section': 'Unidades Evangelion',
        'eva-units-desc': 'Especificaciones técnicas de los mechas EVA',
        'episodes-page': 'Archivo de Episodios',
        'episodes-desc': 'Lista completa de episodios con imágenes y galería',
        'map-page': 'Mapa Táctico',
        'map-desc': 'Mapa interactivo de Tokyo-3 y ubicaciones importantes',
        'report-page': 'Reporte de Misión',
        'report-desc': 'Sistema de evaluación de pilotos y reportes NERV',
        'language-system': 'Sistema de Idiomas',
        'language-desc': 'Traducción automática entre japonés y español',
        'responsive-nav': 'Navegación Responsiva',
        'responsive-desc': 'Adaptación automática a diferentes dispositivos',
        'visual-effects': 'Efectos Visuales',
        'visual-desc': 'Animaciones y efectos inspirados en la serie',
        'video-player': 'Reproductor de Video',
        'video-desc': 'Controles personalizados para contenido multimedia',
        'academic-project-info': 'Proyecto Académico',
        'academic-desc': 'Desarrollado para la materia Programación 4',
        'developer-info': 'Desarrollador',
        'developer-desc': 'Agustín Citti',
        'technologies-info': 'Tecnologías',
        'technologies-desc': 'HTML5, CSS3, JavaScript, Mapbox GL JS',
        'sitemap-link': 'Mapa del Sitio'
    }
};
